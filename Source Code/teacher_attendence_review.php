<?php 
    ...
    if($action=="updateAttend"){
        ...
        $query = "SELECT * from attendence INNER join teacher_attendence on attendence.attend_id=teacher_attendence.Attend_id and attendence.date='$date' and teacher_attendence.teacher_id=$id_for_students";
        ...
        if($count==1){
            ...
            echo "Teacher with id ".$id_for_students." is ".$status." on date ".$date;
            echo "<br><br><br><br>";
